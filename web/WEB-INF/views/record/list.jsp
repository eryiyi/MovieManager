    ...
    <div class="box ui-draggable ui-droppable">
      ...
      <div class="box-content">
        ...
        <form class="form-inline">
          <button type="submit" onclick="toAdd()" class="btn btn-default btn-sm">添加</button>
        </form>
...
<script type="text/javascript">
  function searchIndex(e){
    ...
    if(_index <= ${page.pageCount} && _index >= 1){
      if(mm_msg_type == 0){
        window.location.href="#module=/record/listQiugou&page="+page+"&size="+size;
      }else{
        window.location.href="#module=/record/listGongying&page="+page+"&size="+size;
      }
